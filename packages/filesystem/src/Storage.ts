import { CustomDiskDriverRegistry, DriverConfig, FileLike, FilesystemConfig, KnownDisks } from './types'
...
> implements DriverContract {
     ...
     */
    static disk<K extends keyof KnownDisks | keyof CustomDiskDriverRegistry> (
        diskName?: K
    ): Storage<K> {
