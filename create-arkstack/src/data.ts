...
export const depsList: Record<string, string> = {
    ...
    '@arkstack/console': '^0.12.11',
    '@arkstack/foundry': '^0.12.11',
    // '@arkstack/console-slim': '^0.12.11', Depracated
    '@arkstack/contract': '^0.12.11',
    '@arkstack/database': '^0.12.11',
    '@arkstack/driver-express': '^0.12.11',
    '@arkstack/driver-h3': '^0.12.11',
    '@arkstack/filesystem': '^0.12.11',
    '@arkstack/http': '^0.12.11',
    '@arkstack/view': '^0.12.11',
    '@arkstack/notifications': '^0.12.11',
}
