...
export const depsList: Record<string, string> = {
    '@arkstack/auth': '^0.17.3',
    '@arkstack/cache': '^0.17.3',
    '@arkstack/common': '^0.17.3',
    '@arkstack/console': '^0.17.3',
    '@arkstack/foundry': '^0.17.3',
    '@arkstack/jobs': '^0.17.3',
    // '@arkstack/console-slim': '^0.17.3', Depracated
    '@arkstack/contract': '^0.17.3',
    '@arkstack/database': '^0.17.3',
    '@arkstack/driver-express': '^0.17.3',
    '@arkstack/driver-h3': '^0.17.3',
    '@arkstack/filesystem': '^0.17.3',
    '@arkstack/http': '^0.17.3',
    '@arkstack/view': '^0.17.3',
    '@arkstack/queue': '^0.17.3',
    '@arkstack/scheduler': '^0.17.3',
    '@arkstack/notifications': '^0.17.3',
