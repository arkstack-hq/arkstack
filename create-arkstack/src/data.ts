...
export const depsList: Record<string, string> = {
    '@arkstack/auth': '^0.17.13',
    '@arkstack/cache': '^0.17.13',
    '@arkstack/common': '^0.17.13',
    '@arkstack/console': '^0.17.13',
    '@arkstack/foundry': '^0.17.13',
    '@arkstack/jobs': '^0.17.13',
    // '@arkstack/console-slim': '^0.17.13', Depracated
    '@arkstack/contract': '^0.17.13',
    '@arkstack/database': '^0.17.13',
    '@arkstack/driver-express': '^0.17.13',
    '@arkstack/driver-h3': '^0.17.13',
    '@arkstack/filesystem': '^0.17.13',
    '@arkstack/http': '^0.17.13',
    '@arkstack/view': '^0.17.13',
    '@arkstack/queue': '^0.17.13',
    '@arkstack/scheduler': '^0.17.13',
    '@arkstack/notifications': '^0.17.13',
