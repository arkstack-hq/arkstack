...
export const depsList: Record<string, string> = {
    '@arkstack/auth': '^0.17.20',
    '@arkstack/cache': '^0.17.20',
    '@arkstack/common': '^0.17.20',
    '@arkstack/console': '^0.17.20',
    '@arkstack/foundry': '^0.17.20',
    '@arkstack/jobs': '^0.17.20',
    // '@arkstack/console-slim': '^0.17.20', Depracated
    '@arkstack/contract': '^0.17.20',
    '@arkstack/database': '^0.17.20',
    '@arkstack/driver-express': '^0.17.20',
    '@arkstack/driver-h3': '^0.17.20',
    '@arkstack/filesystem': '^0.17.20',
    '@arkstack/http': '^0.17.20',
    '@arkstack/view': '^0.17.20',
    '@arkstack/queue': '^0.17.20',
    '@arkstack/scheduler': '^0.17.20',
    '@arkstack/notifications': '^0.17.20',
