...
export const depsList: Record<string, string> = {
    ...
    '@arkstack/console': '^0.9.0',
    // '@arkstack/console-slim': '^0.9.0', Depracated
    '@arkstack/contract': '^0.9.0',
    '@arkstack/database': '^0.9.0',
    '@arkstack/driver-express': '^0.9.0',
    '@arkstack/driver-h3': '^0.9.0',
    '@arkstack/filesystem': '^0.9.0',
    '@arkstack/http': '^0.9.0',
    '@arkstack/view': '^0.9.0',
    '@arkstack/notifications': '^0.9.0',
}
