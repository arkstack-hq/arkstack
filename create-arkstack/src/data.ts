...
export const depsList: Record<string, string> = {
    '@arkstack/auth': '^0.17.23',
    '@arkstack/cache': '^0.17.23',
    '@arkstack/common': '^0.17.23',
    '@arkstack/console': '^0.17.23',
    '@arkstack/foundry': '^0.17.23',
    '@arkstack/jobs': '^0.17.23',
    // '@arkstack/console-slim': '^0.17.23', Depracated
    '@arkstack/contract': '^0.17.23',
    '@arkstack/database': '^0.17.23',
    '@arkstack/driver-express': '^0.17.23',
    '@arkstack/driver-h3': '^0.17.23',
    '@arkstack/filesystem': '^0.17.23',
    '@arkstack/http': '^0.17.23',
    '@arkstack/view': '^0.17.23',
    '@arkstack/queue': '^0.17.23',
    '@arkstack/scheduler': '^0.17.23',
    '@arkstack/notifications': '^0.17.23',
