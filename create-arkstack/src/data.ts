...
export const depsList: Record<string, string> = {
    ...
    '@arkstack/cache': '^0.14.14',
    '@arkstack/common': '^0.14.14',
    '@arkstack/console': '^0.14.14',
    '@arkstack/foundry': '^0.14.14',
    '@arkstack/jobs': '^0.14.14',
    // '@arkstack/console-slim': '^0.14.14', Depracated
    '@arkstack/contract': '^0.14.14',
    '@arkstack/database': '^0.14.14',
    '@arkstack/driver-express': '^0.14.14',
    '@arkstack/driver-h3': '^0.14.14',
    '@arkstack/filesystem': '^0.14.14',
    '@arkstack/http': '^0.14.14',
    '@arkstack/view': '^0.14.14',
    '@arkstack/queue': '^0.14.14',
    '@arkstack/notifications': '^0.14.14',
