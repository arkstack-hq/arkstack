...
export const depsList: Record<string, string> = {
    '@arkstack/auth': '^0.17.26',
    '@arkstack/cache': '^0.17.26',
    '@arkstack/common': '^0.17.26',
    '@arkstack/console': '^0.17.26',
    '@arkstack/foundry': '^0.17.26',
    '@arkstack/jobs': '^0.17.26',
    // '@arkstack/console-slim': '^0.17.26', Depracated
    '@arkstack/contract': '^0.17.26',
    '@arkstack/database': '^0.17.26',
    '@arkstack/driver-express': '^0.17.26',
    '@arkstack/driver-h3': '^0.17.26',
    '@arkstack/filesystem': '^0.17.26',
    '@arkstack/http': '^0.17.26',
    '@arkstack/view': '^0.17.26',
    '@arkstack/queue': '^0.17.26',
    '@arkstack/scheduler': '^0.17.26',
    '@arkstack/notifications': '^0.17.26',
