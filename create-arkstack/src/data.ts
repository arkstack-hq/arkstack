...
export const depsList: Record<string, string> = {
    ...
    '@arkstack/console': '^0.6.2',
    // '@arkstack/console-slim': '^0.6.2', Depracated
    '@arkstack/contract': '^0.6.2',
    '@arkstack/database': '^0.6.2',
    '@arkstack/driver-express': '^0.6.2',
    '@arkstack/driver-h3': '^0.6.2',
    '@arkstack/filesystem': '^0.6.2',
    '@arkstack/http': '^0.6.2',
    '@arkstack/view': '^0.6.2',
    '@arkstack/notifications': '^0.6.2',
}
