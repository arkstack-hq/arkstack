...
export const depsList: Record<string, string> = {
    '@arkstack/auth': '^0.17.6',
    '@arkstack/cache': '^0.17.6',
    '@arkstack/common': '^0.17.6',
    '@arkstack/console': '^0.17.6',
    '@arkstack/foundry': '^0.17.6',
    '@arkstack/jobs': '^0.17.6',
    // '@arkstack/console-slim': '^0.17.6', Depracated
    '@arkstack/contract': '^0.17.6',
    '@arkstack/database': '^0.17.6',
    '@arkstack/driver-express': '^0.17.6',
    '@arkstack/driver-h3': '^0.17.6',
    '@arkstack/filesystem': '^0.17.6',
    '@arkstack/http': '^0.17.6',
    '@arkstack/view': '^0.17.6',
    '@arkstack/queue': '^0.17.6',
    '@arkstack/scheduler': '^0.17.6',
    '@arkstack/notifications': '^0.17.6',
