...
export const depsList: Record<string, string> = {
    '@arkstack/auth': '^0.17.22',
    '@arkstack/cache': '^0.17.22',
    '@arkstack/common': '^0.17.22',
    '@arkstack/console': '^0.17.22',
    '@arkstack/foundry': '^0.17.22',
    '@arkstack/jobs': '^0.17.22',
    // '@arkstack/console-slim': '^0.17.22', Depracated
    '@arkstack/contract': '^0.17.22',
    '@arkstack/database': '^0.17.22',
    '@arkstack/driver-express': '^0.17.22',
    '@arkstack/driver-h3': '^0.17.22',
    '@arkstack/filesystem': '^0.17.22',
    '@arkstack/http': '^0.17.22',
    '@arkstack/view': '^0.17.22',
    '@arkstack/queue': '^0.17.22',
    '@arkstack/scheduler': '^0.17.22',
    '@arkstack/notifications': '^0.17.22',
