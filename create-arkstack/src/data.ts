...
export const depsList: Record<string, string> = {
    ...
    '@arkstack/console': '^0.17.17',
    '@arkstack/foundry': '^0.17.17',
    '@arkstack/jobs': '^0.17.17',
    // '@arkstack/console-slim': '^0.17.17', Depracated
    '@arkstack/contract': '^0.17.17',
    '@arkstack/database': '^0.17.17',
    '@arkstack/driver-express': '^0.17.17',
    '@arkstack/driver-h3': '^0.17.17',
    '@arkstack/filesystem': '^0.17.17',
    '@arkstack/http': '^0.17.17',
    '@arkstack/view': '^0.17.17',
    '@arkstack/queue': '^0.17.17',
    '@arkstack/scheduler': '^0.17.17',
    '@arkstack/notifications': '^0.17.17',
