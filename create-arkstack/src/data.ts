...
export const depsList: Record<string, string> = {
    ...
    '@arkstack/driver-express': '^0.10.10',
    '@arkstack/driver-h3': '^0.10.10',
    '@arkstack/filesystem': '^0.10.10',
    '@arkstack/http': '^0.10.10',
    '@arkstack/view': '^0.10.10',
    '@arkstack/notifications': '^0.10.10',
}
