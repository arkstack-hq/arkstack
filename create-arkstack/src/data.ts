...
export const depsList: Record<string, string> = {
    '@arkstack/auth': '^0.17.24',
    '@arkstack/cache': '^0.17.24',
    '@arkstack/common': '^0.17.24',
    '@arkstack/console': '^0.17.24',
    '@arkstack/foundry': '^0.17.24',
    '@arkstack/jobs': '^0.17.24',
    // '@arkstack/console-slim': '^0.17.24', Depracated
    '@arkstack/contract': '^0.17.24',
    '@arkstack/database': '^0.17.24',
    '@arkstack/driver-express': '^0.17.24',
    '@arkstack/driver-h3': '^0.17.24',
    '@arkstack/filesystem': '^0.17.24',
    '@arkstack/http': '^0.17.24',
    '@arkstack/view': '^0.17.24',
    '@arkstack/queue': '^0.17.24',
    '@arkstack/scheduler': '^0.17.24',
    '@arkstack/notifications': '^0.17.24',
