...
export const depsList: Record<string, string> = {
    ...
    '@arkstack/console': '^0.5.1',
    // '@arkstack/console-slim': '^0.5.1', Depracated
    '@arkstack/contract': '^0.5.1',
    '@arkstack/database': '^0.5.1',
    '@arkstack/driver-express': '^0.5.1',
    '@arkstack/driver-h3': '^0.5.1',
    '@arkstack/filesystem': '^0.5.1',
    '@arkstack/http': '^0.5.1',
    '@arkstack/view': '^0.5.1',
    '@arkstack/notifications': '^0.5.1',
}
