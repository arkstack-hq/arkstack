...
export const depsList: Record<string, string> = {
    ...
    '@arkstack/console': '^0.3.15',
    '@arkstack/contract': '^0.3.15',
    '@arkstack/driver-h3': '^0.3.15',
    '@arkstack/filesystem': '^0.3.15',
    '@arkstack/driver-express': '^0.3.15',
}