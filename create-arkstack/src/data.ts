...
export const depsList: Record<string, string> = {
    '@arkstack/auth': '^0.10.0',
    '@arkstack/common': '^0.10.0',
    '@arkstack/console': '^0.10.0',
    // '@arkstack/console-slim': '^0.10.0', Depracated
    '@arkstack/contract': '^0.10.0',
    '@arkstack/database': '^0.10.0',
    '@arkstack/driver-express': '^0.10.0',
    '@arkstack/driver-h3': '^0.10.0',
    '@arkstack/filesystem': '^0.10.0',
    '@arkstack/http': '^0.10.0',
    '@arkstack/view': '^0.10.0',
    '@arkstack/notifications': '^0.10.0',
}
