...
export const depsList: Record<string, string> = {
    ...
    '@arkstack/cache': '^0.17.25',
    '@arkstack/common': '^0.17.25',
    '@arkstack/console': '^0.17.25',
    '@arkstack/foundry': '^0.17.25',
    '@arkstack/jobs': '^0.17.25',
    // '@arkstack/console-slim': '^0.17.25', Depracated
    '@arkstack/contract': '^0.17.25',
    '@arkstack/database': '^0.17.25',
    '@arkstack/driver-express': '^0.17.25',
    '@arkstack/driver-h3': '^0.17.25',
    '@arkstack/filesystem': '^0.17.25',
    '@arkstack/http': '^0.17.25',
    '@arkstack/view': '^0.17.25',
    '@arkstack/queue': '^0.17.25',
    '@arkstack/scheduler': '^0.17.25',
    '@arkstack/notifications': '^0.17.25',
