...
export const depsList: Record<string, string> = {
    ...
    '@arkstack/cache': '^0.17.4',
    '@arkstack/common': '^0.17.4',
    '@arkstack/console': '^0.17.4',
    '@arkstack/foundry': '^0.17.4',
    '@arkstack/jobs': '^0.17.4',
    // '@arkstack/console-slim': '^0.17.4', Depracated
    '@arkstack/contract': '^0.17.4',
    '@arkstack/database': '^0.17.4',
    '@arkstack/driver-express': '^0.17.4',
    '@arkstack/driver-h3': '^0.17.4',
    '@arkstack/filesystem': '^0.17.4',
    '@arkstack/http': '^0.17.4',
    '@arkstack/view': '^0.17.4',
    '@arkstack/queue': '^0.17.4',
    '@arkstack/scheduler': '^0.17.4',
    '@arkstack/notifications': '^0.17.4',
