...
export const depsList: Record<string, string> = {
    '@arkstack/auth': '^0.17.8',
    '@arkstack/cache': '^0.17.8',
    '@arkstack/common': '^0.17.8',
    '@arkstack/console': '^0.17.8',
    '@arkstack/foundry': '^0.17.8',
    '@arkstack/jobs': '^0.17.8',
    // '@arkstack/console-slim': '^0.17.8', Depracated
    '@arkstack/contract': '^0.17.8',
    '@arkstack/database': '^0.17.8',
    '@arkstack/driver-express': '^0.17.8',
    '@arkstack/driver-h3': '^0.17.8',
    '@arkstack/filesystem': '^0.17.8',
    '@arkstack/http': '^0.17.8',
    '@arkstack/view': '^0.17.8',
    '@arkstack/queue': '^0.17.8',
    '@arkstack/scheduler': '^0.17.8',
    '@arkstack/notifications': '^0.17.8',
