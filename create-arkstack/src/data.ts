...
export const depsList: Record<string, string> = {
    '@arkstack/auth': '^0.17.5',
    '@arkstack/cache': '^0.17.5',
    '@arkstack/common': '^0.17.5',
    '@arkstack/console': '^0.17.5',
    '@arkstack/foundry': '^0.17.5',
    '@arkstack/jobs': '^0.17.5',
    // '@arkstack/console-slim': '^0.17.5', Depracated
    '@arkstack/contract': '^0.17.5',
    '@arkstack/database': '^0.17.5',
    '@arkstack/driver-express': '^0.17.5',
    '@arkstack/driver-h3': '^0.17.5',
    '@arkstack/filesystem': '^0.17.5',
    '@arkstack/http': '^0.17.5',
    '@arkstack/view': '^0.17.5',
    '@arkstack/queue': '^0.17.5',
    '@arkstack/scheduler': '^0.17.5',
    '@arkstack/notifications': '^0.17.5',
