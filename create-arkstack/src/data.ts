...
export const depsList: Record<string, string> = {
    ...
    '@arkstack/console': '^0.12.21',
    '@arkstack/foundry': '^0.12.21',
    // '@arkstack/console-slim': '^0.12.21', Depracated
    '@arkstack/contract': '^0.12.21',
    '@arkstack/database': '^0.12.21',
    '@arkstack/driver-express': '^0.12.21',
    '@arkstack/driver-h3': '^0.12.21',
    '@arkstack/filesystem': '^0.12.21',
    '@arkstack/http': '^0.12.21',
    '@arkstack/view': '^0.12.21',
    '@arkstack/notifications': '^0.12.21',
}
