...
export const depsList: Record<string, string> = {
    '@arkstack/auth': '^0.17.10',
    '@arkstack/cache': '^0.17.10',
    '@arkstack/common': '^0.17.10',
    '@arkstack/console': '^0.17.10',
    '@arkstack/foundry': '^0.17.10',
    '@arkstack/jobs': '^0.17.10',
    // '@arkstack/console-slim': '^0.17.10', Depracated
    '@arkstack/contract': '^0.17.10',
    '@arkstack/database': '^0.17.10',
    '@arkstack/driver-express': '^0.17.10',
    '@arkstack/driver-h3': '^0.17.10',
    '@arkstack/filesystem': '^0.17.10',
    '@arkstack/http': '^0.17.10',
    '@arkstack/view': '^0.17.10',
    '@arkstack/queue': '^0.17.10',
    '@arkstack/scheduler': '^0.17.10',
    '@arkstack/notifications': '^0.17.10',
