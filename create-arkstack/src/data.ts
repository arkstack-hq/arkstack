...
export const depsList: Record<string, string> = {
    '@arkstack/auth': '^0.11.2',
    '@arkstack/common': '^0.11.2',
    '@arkstack/console': '^0.11.2',
    '"@arkstack/foundry': '^0.10.10',
    // '@arkstack/console-slim': '^0.11.2', Depracated
    '@arkstack/contract': '^0.11.2',
    '@arkstack/database': '^0.11.2',
    '@arkstack/driver-express': '^0.11.2',
    '@arkstack/driver-h3': '^0.11.2',
    '@arkstack/filesystem': '^0.11.2',
    '@arkstack/http': '^0.11.2',
    '@arkstack/view': '^0.11.2',
    '@arkstack/notifications': '^0.11.2',
}
