...
export const depsList: Record<string, string> = {
    ...
    '@arkstack/cache': '^0.14.15',
    '@arkstack/common': '^0.14.15',
    '@arkstack/console': '^0.14.15',
    '@arkstack/foundry': '^0.14.15',
    '@arkstack/jobs': '^0.14.15',
    // '@arkstack/console-slim': '^0.14.15', Depracated
    '@arkstack/contract': '^0.14.15',
    '@arkstack/database': '^0.14.15',
    '@arkstack/driver-express': '^0.14.15',
    '@arkstack/driver-h3': '^0.14.15',
    '@arkstack/filesystem': '^0.14.15',
    '@arkstack/http': '^0.14.15',
    '@arkstack/view': '^0.14.15',
    '@arkstack/queue': '^0.14.15',
    '@arkstack/notifications': '^0.14.15',
