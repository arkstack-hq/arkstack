...
export const depsList: Record<string, string> = {
    ...
    '@arkstack/console': '^0.4.2',
    '@arkstack/contract': '^0.4.2',
    '@arkstack/driver-h3': '^0.4.2',
    '@arkstack/filesystem': '^0.4.2',
    '@arkstack/driver-express': '^0.4.2',
    '@arkstack/notifications': '^0.4.2',
}
