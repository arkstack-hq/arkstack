...
export const depsList: Record<string, string> = {
    '@arkstack/auth': '^0.17.21',
    '@arkstack/cache': '^0.17.21',
    '@arkstack/common': '^0.17.21',
    '@arkstack/console': '^0.17.21',
    '@arkstack/foundry': '^0.17.21',
    '@arkstack/jobs': '^0.17.21',
    // '@arkstack/console-slim': '^0.17.21', Depracated
    '@arkstack/contract': '^0.17.21',
    '@arkstack/database': '^0.17.21',
    '@arkstack/driver-express': '^0.17.21',
    '@arkstack/driver-h3': '^0.17.21',
    '@arkstack/filesystem': '^0.17.21',
    '@arkstack/http': '^0.17.21',
    '@arkstack/view': '^0.17.21',
    '@arkstack/queue': '^0.17.21',
    '@arkstack/scheduler': '^0.17.21',
    '@arkstack/notifications': '^0.17.21',
