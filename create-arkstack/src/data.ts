...
export const depsList: Record<string, string> = {
    ...
    '@arkstack/cache': '^0.17.14',
    '@arkstack/common': '^0.17.14',
    '@arkstack/console': '^0.17.14',
    '@arkstack/foundry': '^0.17.14',
    '@arkstack/jobs': '^0.17.14',
    // '@arkstack/console-slim': '^0.17.14', Depracated
    '@arkstack/contract': '^0.17.14',
    '@arkstack/database': '^0.17.14',
    '@arkstack/driver-express': '^0.17.14',
    '@arkstack/driver-h3': '^0.17.14',
    '@arkstack/filesystem': '^0.17.14',
    '@arkstack/http': '^0.17.14',
    '@arkstack/view': '^0.17.14',
    '@arkstack/queue': '^0.17.14',
    '@arkstack/scheduler': '^0.17.14',
    '@arkstack/notifications': '^0.17.14',
